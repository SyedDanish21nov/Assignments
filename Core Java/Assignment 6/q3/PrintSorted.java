...
public class PrintSorted {
	...
	public static void main(String[] args) {
				 ...
				 Employee emp1 = new Employee(1, "Aman", "A", 54000L);
				 Employee emp2 = new Employee(3, "Aman", "D", 65000L);
				 Employee emp3 = new Employee(2, "Ashok", "C", 34000L);
				 Employee emp4 = new Employee(4, "Vinay", "B", 76000L);
